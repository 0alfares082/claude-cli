...
- المهمة ما لها حد وقت افتراضيا. لا تضيف `--timeout` الا اذا المستخدم طلب مهلة محددة. القيمة `0` تعني بدون حد وقت بعد.
- فحص تسجيل الدخول ومساعدة CLI لهم مهلة قصيرة منفصلة، مو مهلة لشغل Claude.
- اذا المهمة فشلت او وقفتها، ممكن يكون فيه تعديل جزئي. افحص الملفات قبل تعيدها.
