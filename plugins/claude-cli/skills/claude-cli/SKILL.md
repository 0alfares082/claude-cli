...
6. Use the host's asynchronous shell session support for long runs and poll with bounded waits. A timeout stops the child process group and may leave partial edits. Inspect them before retrying. There is no automatic retry or fallback.
